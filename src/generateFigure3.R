...
scale_fill_gradient(low="white", high="blue") +
  theme(text = element_text(size=22),axis.title=element_text( size=22), legend.title=element_text(size=22), panel.background = element_rect(fill="white", color="black"), panel.grid.major = element_line(color="white"), panel.grid.minor = element_line(color="white"), legend.key = element_rect(fill="white", size=.5, linetype="dotted"), plot.title = element_text( size=22)) +  
...
f1d.1000 = ggplot(summary(boost.evo_1d_1000trees), aes(x= reorder(var, rel.inf),y= rel.inf)) + geom_bar(stat = "identity", fill="darkgreen", col="black") + coord_flip() + theme(plot.title = element_text(hjust = 0.5, size=22), panel.background = element_rect(fill="white", color="black"), panel.grid.major = element_line(color="white"), panel.grid.minor = element_line(color="white"), axis.title = element_text(size = 17), axis.text = element_text(size = 15)) + ylab("")  + xlab("") + labs(title="1,000 Trees")
f1d.10k = ggplot(summary(boost.evo_1d), aes(x= reorder(var, rel.inf),y= rel.inf)) + geom_bar(stat = "identity", fill="darkgreen", col="black") + coord_flip() + theme(plot.title = element_text(hjust = 0.5, size=22), panel.background = element_rect(fill="white", color="black"), panel.grid.major = element_line(color="white"), panel.grid.minor = element_line(color="white"), axis.title = element_text(size = 17), axis.text = element_text(size = 15)) + ylab("") + xlab("") + labs(title="10,000 Trees")

f4d.500 = ggplot(summary(boost.evo_4d_500trees), aes(x= reorder(var, rel.inf),y= rel.inf)) + geom_bar(stat = "identity", fill="darkgreen", col="black") + coord_flip() + theme(panel.background = element_rect(fill="white", color="black"), panel.grid.major = element_line(color="white"), panel.grid.minor = element_line(color="white"), axis.title = element_text(size = 17), axis.text = element_text(size = 15)) + ylab("")  + xlab("Depth = 4") 
f4d.1000 = ggplot(summary(boost.evo_4d_1000trees), aes(x= reorder(var, rel.inf),y= rel.inf)) + geom_bar(stat = "identity", fill="darkgreen", col="black") + coord_flip() + theme(panel.background = element_rect(fill="white", color="black"), panel.grid.major = element_line(color="white"), panel.grid.minor = element_line(color="white"), axis.title = element_text(size = 17), axis.text = element_text(size = 15)) + ylab("")  + xlab("") 
...
f5d.500 = ggplot(summary(boost.evo_5d_500trees), aes(x= reorder(var, rel.inf),y= rel.inf)) + geom_bar(stat = "identity", fill="darkgreen", col="black") + coord_flip() + theme(panel.background = element_rect(fill="white", color="black"), panel.grid.major = element_line(color="white"), panel.grid.minor = element_line(color="white"), axis.title = element_text(size = 17), axis.text = element_text(size = 15)) + ylab("") + xlab("Depth = 5") 
f5d.1000 = ggplot(summary(boost.evo_5d_1000trees), aes(x= reorder(var, rel.inf),y= rel.inf)) + geom_bar(stat = "identity", fill="darkgreen", col="black") + coord_flip() + theme(panel.background = element_rect(fill="white", color="black"), panel.grid.major = element_line(color="white"), panel.grid.minor = element_line(color="white"), axis.title = element_text(size = 22), axis.text = element_text(size = 15)) + ylab("Relative Influence") + xlab("") 
